                        ...
                        children: [
                          Padding(
                            ...
                            child: FlutterFlowPlacePicker(
                              iOSGoogleMapsApiKey:
                                  'AIzaSyAP3bCxpWW9xdRZWoAoZP4WicF8Et0uE7o',
                              androidGoogleMapsApiKey:
                                  'AIzaSyAFnC0ngkiRx0JMvKhhkw_olI8-QtKoaD0',
                              webGoogleMapsApiKey:
                                  'AIzaSyCFKnPAGEr0jImHeLzOqI7On_-Z3gLTQ8Y',
                              onSelect: (place) =>
                                  setState(() => placePickerValue = place),
                              defaultText: 'Lägg till adress',
                              icon: Icon(
                                Icons.place,
                                color: FlutterFlowTheme.iconGray,
                                size: 24,
