...
const _kTestStripePublishableKey =
    'pk_test_51K7xNaLbhFkGfHiFNkzKDHVFzTH0cweWbMwUw2UOvlmFDcLjpJS3XYM210Q9wwAPbKYXXklXBDsCxwUVoLn1KIk400QDgJVmrD';
  ...
  try {
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName: 'Wifree',
        merchantCountryCode: 'SV',
        testEnv: !_isProd,
